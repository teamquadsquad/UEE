...
public class learnMisk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learn_misk);
    ...
    public void openMisc1() {
        Intent intent = new Intent(this, learnMisc1.class);
        startActivity(intent);
    }

    public void openMisc2() {
        Intent intent = new Intent(this, learnMisc2.class);
        startActivity(intent);
    }

    public void openMisc3() {
        Intent intent = new Intent(this, learnMisc3.class);
        startActivity(intent);
    }

    public void openMisc4() {
        Intent intent = new Intent(this, learnMisc4.class);
        startActivity(intent);
    }
